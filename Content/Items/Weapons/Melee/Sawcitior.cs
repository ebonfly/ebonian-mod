...
{
    public override string Texture => Helper.AssetPath + "Items/Weapons/Melee/Sawcitior";
...
{
    public override string Texture => Helper.AssetPath + "Items/Weapons/Melee/SawcitiorP";
    ...
    public override void AI()
    {
        ...
        if (player.active)
        {
            ...
            if (Projectile.ai[0] == 33)
            {
                ...
                SoundEngine.PlaySound(Sounds.chomp1.WithVolumeScale(0.7f), Projectile.Center);
            }
