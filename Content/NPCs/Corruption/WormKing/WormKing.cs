...
using EbonianMod.Content.NPCs.Corruption.Ebonflies;
using EbonianMod.Content.NPCs.Corruption.Rotling;
...
namespace EbonianMod.Content.NPCs.Corruption.WormKing;

public class WormKing : ModNPC
{
    public override string Texture => Helper.AssetPath + "NPCs/Corruption/WormKing/"+Name;
    public override void SetStaticDefaults()
    {
        var drawModifier = new NPCID.Sets.NPCBestiaryDrawModifiers()
        {
            CustomTexturePath = Helper.AssetPath+"NPCs/Corruption/WormKing/WormKing_Bestiary",
            ...
            case Slam:
                {
                    ...
                    if (Helper.Raycast(NPC.Center, -Vector2.UnitY, NPC.height * 2).RayLength < NPC.height && AITimer2 == 0)
                    {
                        ...
                        MPUtils.NewProjectile(NPC.GetSource_FromThis(), NPC.Center, Vector2.Zero, ProjectileType<GluttonImpact>(), 0, 0, 0, 0);
