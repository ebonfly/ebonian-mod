...
{
    public override string Texture => Helper.AssetPath + "NPCs/Corruption/FleshBricks/"+Name;
    ...
    public override void AI()
    {
        ...
        switch (AIState)
        {
            ...
            case X:
                ...
                if (NPC.Center.X.InRange(player.Center.X, NPC.height / 2) && AITimer > 3)
                    AITimer = 31;
                if (AITimer > 30)
                {
                    NPC.netUpdate = true;
            ...
            case Y:
                ...
                if (NPC.Center.Y.InRange(player.Center.Y, NPC.width / 2) && AITimer > 3)
                    AITimer = 31;
                if (AITimer > 30)
                {
                    NPC.netUpdate = true;
