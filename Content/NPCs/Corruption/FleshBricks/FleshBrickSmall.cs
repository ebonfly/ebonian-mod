...
{
    public override string Texture => Helper.AssetPath + "NPCs/Corruption/FleshBricks/FleshBrickSmall0";
    ...
    public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
    {
        ...
        if (NPC.ai[3] >= 0 && NPC.ai[3] < 3)
            texture = Helper.GetTexture(Helper.AssetPath+"NPCs/Corruption/FleshBricks/FleshBrickSmall" + NPC.ai[3]).Value;
        for (int i = 0; i < 5; i++)
        {
